...
public class AddaBook_Page extends KaplanSpecificWrappers
{
	...
	//Enter ISBN number
		public AddaBook_Page enterISBNNumber(String isbn)
		{
		enterDataById(objec.getProperty("Addabook.ISBNno.Id"), isbn);
		return this;
		}
	//Enter ISBN number
		public AddaBook_Page enterPasscode(String passcode)
		{
			enterDataById(objec.getProperty("Addabook.Passcode.Id"),passcode);
		return this;
		}	
	//Enter ISBN number
		public AddaBook_Page clickAddabook()
		{
		clickByClassName(objec.getProperty("Addabook.addabookbutton.class"));
		return this;
		}	
