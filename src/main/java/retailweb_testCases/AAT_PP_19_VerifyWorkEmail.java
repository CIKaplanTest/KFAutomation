...
public class AAT_PP_19_VerifyWorkEmail extends KaplanSpecificWrappers {

		@BeforeClass
		public void setData() {
			testCaseName = "AAT_PP_19";
			testDescription = "AAT ProductPicker";
			browserName = "chrome,sysRetailURL";
			dataSheetName = "AAT_PP_VerifyWorkEmail";
			category = "Smoke";
			authors = "Sonia";
		...
		public void AAT_PPic_19(String userName,String password,String paypalUsername,String paypalPassword) throws InterruptedException {
